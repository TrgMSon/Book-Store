...
(26,'Số đỏ','Số đỏ là tiểu thuyết trào phúng nổi tiếng của Vũ Trọng Phụng, đăng báo năm 1936 và in sách lần đầu năm 1938. Tác phẩm xây dựng hình tượng Xuân Tóc Đỏ để châm biếm sâu cay xã hội thị dân nửa Tây nửa ta đương thời. Đây là kiệt tác của văn học hiện thực phê phán Việt Nam trước 1945.','Vũ Trọng Phụng','1938-01-01 00:00:00',128000,21,'/uploads/sodo.jpg','Vietnamese literature'),
...
(29,'Vợ chồng A Phủ','Vợ chồng A Phủ là truyện ngắn nổi tiếng của Tô Hoài, sáng tác năm 1952 và in trong tập Truyện Tây Bắc. Tác phẩm phản ánh số phận đau khổ của người lao động miền núi dưới ách thống trị phong kiến, đồng thời ca ngợi sức sống tiềm tàng và khát vọng tự do của con người. Nhân vật Mị và A Phủ là những hình tượng tiêu biểu của văn học cách mạng Việt Nam.','Tô Hoài','1952-01-01 00:00:00',118000,18,'/uploads/vochongaphu.jpg','Vietnamese literature'),

(30,'Vợ nhặt','Vợ nhặt là truyện ngắn đặc sắc của Kim Lân, in trong tập Con chó xấu xí năm 1962, phát triển từ cốt truyện Xóm ngụ cư viết sau Cách mạng tháng Tám. Tác phẩm lấy bối cảnh nạn đói năm 1945 để làm nổi bật tình người, khát vọng sống và niềm tin của những con người nghèo khổ giữa hoàn cảnh thê thảm. Đây là một trong những truyện ngắn xuất sắc nhất của văn học Việt Nam hiện đại.','Kim Lân','1962-01-01 00:00:00',105000,24,'/uploads/vonhat.jpg','Vietnamese literature'),
